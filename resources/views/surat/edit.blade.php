...
<div class="row ">
  <div class="col-lg-7 mx-auto">
    <div class="card mt-2 mx-auto p-4 bg-light">
        ...
        <div class = "container">
          <form id="contact-form" action="{{ route('surat.update',$item->id) }}" role="form" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="controls">
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <label for="form_name">Nama Surat *</label>
